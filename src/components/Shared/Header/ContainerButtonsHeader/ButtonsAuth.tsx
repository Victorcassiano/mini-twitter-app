...
export function ButtonsAuth() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-1 justify-end space-x-4 [&>button]:h-10 [&>button]:rounded-full [&>button]:transition-colors [&>button]:p-4 [&>button]:text-sm">
      <Button
        variant="outline"
        onClick={() => {
          setTab("register")
